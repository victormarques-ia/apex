  ...
  },
  {
    ...
    handler: async (req: PayloadRequest) => {
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : 'Erro inesperado ao criar plano alimentar'
  ...
  },
  {
    ...
    handler: async (req: PayloadRequest) => {
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : 'Erro inesperado ao buscar plano alimentar'
        return Response.json({ errors: [{ message: errorMessage }] }, { status: 500 })
      }
    },
  },
    ...
    handler: async (req: PayloadRequest) => {
      try {
        ...
        const updateData = {
          ...
          ...(data.totalDailyCalories !== undefined && {
            total_daily_calories: data.totalDailyCalories,
          }),
        ...
        const errorMessage =
          error instanceof Error ? error.message : 'Erro inesperado ao atualizar plano alimentar'
        return Response.json({ errors: [{ message: errorMessage }] }, { status: 500 })
      }
    },
  },
    ...
    handler: async (req: PayloadRequest) => {
      try {
        ...
        const updateDayData = {
          ...
          ...(data.repeatIntervalDays !== undefined && {
        ...
        const errorMessage =
          error instanceof Error
            ? error.message
            : 'Erro inesperado ao atualizar dia do plano alimentar'
        return Response.json({ errors: [{ message: errorMessage }] }, { status: 500 })
      }
    },
  },
    ...
    handler: async (req: PayloadRequest) => {
      try {
        ...
        return Response.json({
          success: true,
          message:
            'Plano alimentar e todos os dias/refeições associados foram excluídos com sucesso',
        })
      } catch (error) {
        console.error('[NutritionistApi][delete-diet-plan]:', error)
        const errorMessage =
          error instanceof Error ? error.message : 'Erro inesperado ao excluir plano alimentar'
        return Response.json({ errors: [{ message: errorMessage }] }, { status: 500 })
      }
    },
  },
  {
    ...
    handler: async (req: PayloadRequest) => {
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : 'Erro inesperado ao excluir plano diário'
        return Response.json({ errors: [{ message: errorMessage }] }, { status: 500 })
      }
    },
  },
  {
    ...
    handler: async (req: PayloadRequest) => {
      try {
        ...
        const errorMessage =
          error instanceof Error ? error.message : 'Erro inesperado ao criar refeição'
        return Response.json({ errors: [{ message: errorMessage }] }, { status: 500 })
      }
    },
  },
