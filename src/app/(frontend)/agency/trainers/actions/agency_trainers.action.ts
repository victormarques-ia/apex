...
// Action to get the trainer list
export async function getTrainersList(formData: FormData) {
    return actionHandlerWithValidation(
      ...
      async (data) => {
        ...
        // Fetch the athletes
        // change to agency trainers api
        const result = await fetchFromApi(`/api/agencies/my-trainers?${queryParams.toString()}`, {
          method: 'GET',
        });
