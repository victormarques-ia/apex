...
import {
  ...
  getNutritionalTotalsAction,
} from '@/app/(frontend)/athlete/consumption/actions/dailyConsumption.action'
...
interface DailyConsumptionComponentProps {
  athleteId: string
}

export default function DailyConsumptionComponent({ athleteId }: DailyConsumptionComponentProps) {
  ...
  // If loading or error, show in-component message rather than full page
                      ...
                      {foods.map((food) => (
                        ...
                        >
                          ...
                          <p className="text-sm text-gray-600">
                            ...
                            {food.carbs_per_100g}g | G: {food.fat_per_100g}g
                          </p>
                        </div>
                      ))}
                    </div>
                ...
                {selectedFood && (
                  <div className="space-y-2">
                    ...
                    <div className="p-2 border rounded bg-gray-50">
                      ...
                      <p className="text-sm text-gray-600">
                        {selectedFood.calories_per_100g} kcal | P: {selectedFood.protein_per_100g}g
                        | C: {selectedFood.carbs_per_100g}g | G: {selectedFood.fat_per_100g}g
                      </p>
                    </div>
                    ...
                    <Button onClick={addConsumption} disabled={isLoading} className="w-full">
                      {isLoading ? (
              ...
              {isLoading && consumptions.length === 0 ? (
                ...
                <div className="space-y-2">
                  {consumptions.map((consumption) => {
                    ...
                    if (typeof food === 'object') {
                      ...
                      calories = Math.round(
                        ((food.calories_per_100g || 0) * consumption.quantity_grams) / 100,
                      )
                ...
                <div className="text-center py-8">
                  ...
                  <p className="text-sm text-gray-400">
                    Adicione alimentos usando o formulário ao lado.
                  </p>
                </div>
              )}
            </CardContent>
