            ...
            {dietPlans.length === 0 ? (
              ...
              <div className="space-y-2">
                {dietPlans.map(plan => (
                  <div
                    key={plan.id}
                    className={`p-3 rounded-md flex justify-between items-center cursor-pointer ${selectedPlanId === plan.id ? 'bg-primary/10 border border-primary/30' : 'bg-gray-50 hover:bg-gray-100'
                      }`}
