      ...
      try {
        ...
        try {
          const mealsResponse = await fetch(
            `/api/meal/totals?athleteId=${athleteId}&from=${dateRange.from}&to=${dateRange.to}`,
          )
          if (mealsResponse.ok) {
        ...
        try {
          const dailyConsumptionResponse = await fetch(
            `/api/daily-consumption/totals?athleteId=${athleteId}&from=${dateRange.from}&to=${dateRange.to}`,
          )
        ...
        const targets =
          dailyConsumptionData.targets || dailyConsumptionData.totals || defaultDailyTarget
        ...
        <>
          ...
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <Card className="bg-red-100">
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {Math.round(consumptionData.totals.calories)} kcal
                </div>
                <div className="text-xs text-gray-600">
                  {consumptionData.percentage.calories}% da meta diária
                </div>
            ...
            <Card className="bg-green-100">
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {Math.round(consumptionData.totals.carbs)} gramas
                </div>
                <div className="text-xs text-gray-600">
                  {consumptionData.percentage.carbs}% da meta diária
                </div>
                <div className="w-full bg-gray-200 h-2 mt-2 rounded-full overflow-hidden">
                  <div
            ...
            <Card className="bg-purple-100">
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {Math.round(consumptionData.totals.protein)} gramas
                </div>
                <div className="text-xs text-gray-600">
                  {consumptionData.percentage.protein}% da meta diária
                </div>
                <div className="w-full bg-gray-200 h-2 mt-2 rounded-full overflow-hidden">
                  <div
            ...
            <Card className="bg-yellow-100">
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {Math.round(consumptionData.totals.fat)} gramas
                </div>
                <div className="text-xs text-gray-600">
                  {consumptionData.percentage.fat}% da meta diária
                </div>
                <div className="w-full bg-gray-200 h-2 mt-2 rounded-full overflow-hidden">
                  <div
            ...
            <Card className="bg-blue-100">
              ...
              <CardContent>
                <div className="text-2xl font-bold">
                  {consumptionData.totals.water.toFixed(1)} litros
                </div>
                <div className="text-xs text-gray-600">
                  {consumptionData.percentage.water}% da meta diária
                </div>
                <div className="w-full bg-gray-200 h-2 mt-2 rounded-full overflow-hidden">
                  <div
